...
ggplot(PeterPaul.chem.nutrients, aes(x = daynum, 
                                     y = temperature_C, 
                                     color = year4)) +
...
ggplot(PeterPaul.chem.nutrients, aes(sampledate, temperature_C, color = depth)) + 
  dotsize = 0.5 +
...
ggplot(EPAair, aes(x = PM2.5, y = Ozone, alpha = 0.5, color = mean_Latitude)) +
