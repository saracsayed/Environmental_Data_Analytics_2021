...
```{r}
# Vectors ----
vector1 <- c(1,2,5.3,6,-2,4) # numeric vector, have to be integers, we can extract values by their position use [] 
vector1
...
# Lists ---- 
list1 <- list(name = "Maria", mynumbers = vector1, mymatrix = matrix1, age = 5.3); list1 #Can mix datatypes
list1[[2]]
...
```{r}
High <- c(53, 55, 54,49,53,56,53,42, 56, 54)
