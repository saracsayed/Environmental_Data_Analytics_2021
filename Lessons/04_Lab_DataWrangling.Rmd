...
NTL.phys.data <- filter(NTL.phys.data, year4 %in% c("1999"))
...
NTL.phys.data.Tuesday.90 <- filter(NTL.phys.data, lakename =="Tuesday Lake"" & year4 %in% (1990:1999) ))

```
Question: Why don't we filter using row numbers?

> Answer: It would mess up the dataset very easily
